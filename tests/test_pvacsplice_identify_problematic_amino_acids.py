...
from pvactools.tools.pvacsplice import identify_problematic_amino_acids
...
class PvacspliceIdentifyProblematicAminoAcidsTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_command(self):
        ...
        self.assertFalse(result.returncode, "Failed `pvacsplice identify_problematic_amino_acids -h`")
