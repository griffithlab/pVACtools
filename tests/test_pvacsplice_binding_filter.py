...
from pvactools.tools.pvacsplice import binding_filter
...
class PvacspliceBindingFilterTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_command(self):
        ...
        self.assertFalse(result.returncode, "Failed `pvacsplice binding_filter -h`")
