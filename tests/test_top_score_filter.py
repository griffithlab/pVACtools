...
class TopScoreFilterTests(unittest.TestCase):
    ...
    def test_runs_and_creates_expected_file_pvacsplice_percentile(self):
        ...
        PvacspliceTopScoreFilter(input_file, output_file_name, top_score_metric='median', transcript_prioritization_strategy=['tsl'], top_score_metric2="percentile").execute()
