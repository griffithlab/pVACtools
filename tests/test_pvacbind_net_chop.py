...
from pvactools.tools.pvacbind import net_chop
...
class PvacbindNetChopTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_command(self):
        ...
        self.assertFalse(result.returncode, "Failed `pvacbind net_chop -h`")
