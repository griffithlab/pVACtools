...
from pvactools.tools.pvacseq import calculate_reference_proteome_similarity
...
class PvacseqCalculateReferenceProteomeSimilarityTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_command(self):
        ...
        self.assertFalse(result.returncode, "Failed `pvacseq calculate_reference_proteome_similarity -h`")
