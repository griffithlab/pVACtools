...
class ParseOutputTests(unittest.TestCase):
    ...
    def test_parse_output_runs_and_produces_expected_output(self):
        parse_output_input_netmhc_file = os.path.join(self.test_data_dir, "input_peptide_sequence_length_21.HLA-A29:02.9.netmhc.xls")
        ...
        parse_output_command = "%s %s %s %s %s %s" % (self.python, self.executable, parse_output_input_netmhc_file, parse_output_input_tsv_file, parse_output_key_file, parse_output_output_file.name)
    ...
    def test_input_frameshift_variant_feature_elongation_gets_parsed_correctly(self):
        parse_output_input_netmhc_file  = os.path.join(self.test_data_dir, "input_frameshift_variant_feature_elongation.HLA-A29:02.9.netmhc.xls")
    ...
    def test_input_frameshift_variant_feature_truncation_gets_parsed_correctly(self):
        parse_output_input_netmhc_file  = os.path.join(self.test_data_dir, "input_frameshift_variant_feature_truncation.HLA-A29:02.9.netmhc.xls")
    ...
    def test_input_inframe_deletion_aa_deletion_gets_parsed_correctly(self):
        parse_output_input_netmhc_file  = os.path.join(self.test_data_dir, "input_inframe_deletion_aa_deletion.HLA-A29:02.9.netmhc.xls")
    ...
    def test_input_inframe_deletion_aa_replacement_gets_parsed_correctly(self):
        parse_output_input_netmhc_file  = os.path.join(self.test_data_dir, "input_inframe_deletion_aa_replacement.HLA-A29:02.9.netmhc.xls")
    ...
    def test_input_inframe_insertion_aa_insertion_gets_parsed_correctly(self):
        parse_output_input_netmhc_file  = os.path.join(self.test_data_dir, "input_inframe_insertion_aa_insertion.HLA-A29:02.9.netmhc.xls")
    ...
    def test_input_frameshift_variant_feature_elongation_gets_parsed_correctly(self):
        parse_output_input_netmhc_file  = os.path.join(self.test_data_dir, "input_inframe_insertion_aa_replacement.HLA-A29:02.9.netmhc.xls")
