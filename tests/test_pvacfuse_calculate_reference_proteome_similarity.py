...
from pvactools.tools.pvacfuse import calculate_reference_proteome_similarity
...
class PvacfuseCalculateReferenceProteomeSimilarityTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_command(self):
        ...
        self.assertFalse(result.returncode, "Failed `pvacfuse calculate_reference_proteome_similarity -h`")
    ...
    def test_runs(self):
        ...
        input_fasta = os.path.join(self.test_data_directory, 'arriba_fusions', 'MHC_Class_I', 'Test.fasta')
