...
from pvactools.tools.pvacsplice import aggregate_report_filter
...
class PvacspliceAggregateReportFilterTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_command(self):
        ...
        self.assertFalse(result.returncode, "Failed `pvacsplice aggregate_report_filter -h`")
