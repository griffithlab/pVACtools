...
from pvactools.tools.pvacsplice import coverage_filter
...
class PvacspliceCoverageFilterTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_command(self):
        ...
        self.assertFalse(result.returncode, "Failed `pvacsplice coverage_filter -h`")
