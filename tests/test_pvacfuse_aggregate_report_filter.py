...
from pvactools.tools.pvacfuse import aggregate_report_filter
...
class PvacfuseAggregateReportFilterTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_command(self):
        ...
        self.assertFalse(result.returncode, "Failed `pvacfuse aggregate_report_filter -h`")
