...
class GenerateFastaTests(unittest.TestCase):
    ...
    def test_input_file_with_peptide_sequence_length_17_generates_expected_file(self):
        ...
        generate_fasta_command = "%s %s %s %s %s" % (self.python, self.executable, generate_fasta_input_file, peptide_sequence_length, generate_fasta_output_file.name)
    ...
    def test_input_file_with_mutation_at_relative_end_of_full_sequence_generates_expected_file(self):
        ...
        generate_fasta_command = "%s %s %s %s %s" % (self.python, self.executable, generate_fasta_input_file, self.peptide_sequence_length, generate_fasta_output_file.name)
