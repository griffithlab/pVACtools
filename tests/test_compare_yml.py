...
import tempfile
import json
from pvactools.tools.pvaccompare.runners.run_compare_yml import main
...
class TestRunCompareYML(unittest.TestCase):
    def setUp(self):
        ...
        self.file_name = "yml_input_data.json"
    ...
    def test_identical_files(self):
        with open(self.data_dir + "yml_input1.yml", "r") as f:
            content = f.read()
    ...
    def test_different_files(self):
        expected_output_path = self.data_dir + "yml_expected_output.json"

        with open(self.data_dir + "yml_input1.yml", "r") as f:
            content1 = f.read()

        with open(self.data_dir + "yml_input2.yml", "r") as f:
            content2 = f.read()
