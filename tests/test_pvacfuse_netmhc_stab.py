...
from pvactools.tools.pvacfuse import netmhc_stab
...
class PvacfuseNetmhcStabTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_command(self):
        ...
        self.assertFalse(result.returncode, "Failed `pvacfuse netmhc_stab -h`")
