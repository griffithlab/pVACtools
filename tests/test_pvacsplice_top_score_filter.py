...
from pvactools.tools.pvacsplice import top_score_filter
...
class PvacspliceTopScoreFilterTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_command(self):
        ...
        self.assertFalse(result.returncode, "Failed `pvacsplice top_score_filter -h`")
