...
from pvactools.tools.pvacseq import netmhc_stab
...
class PvacseqNetmhcStabTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_command(self):
        ...
        self.assertFalse(result.returncode, "Failed `pvacseq netmhc_stab -h`")
