...
if ( !$opt_i || !$opt_o ) {
    ...
    print "Usage: $0\n";
    print
"-i < input FASTA file with variant sequences for wildtype(WT) and mutant(MT) proteins generated using 'GenerateVariantSequences.pl' and filtered using 'FilterSeq.pl'>\n";
