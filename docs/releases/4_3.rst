...
- Update the ``pvacfuse generate_protein_fasta`` command to allow aggregated TSVs as an input TSV
...
- Add new pVACview R files to the list of files getting copied into the pVACseq output folder.
  These files were previously not copied in the the results folder, leading to error when running
