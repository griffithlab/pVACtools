...
- This release refactors the pVACvector graph building algorithm in order to increase the probability
  ...
  see the PR description for the full details. by @susannasiebert in https://github.com/griffithlab/pVACtools/pull/1163
...
- This release fixes a bug with the ``--agregate-inclusion-binding-threshold`` which would not be used if
