...
This is a backport bugfix release. It fixes the following problem first fixed in version 7.1.2:

* Fix AGFusion read support calculation when running with STAR-fusion input by @susannasiebert in https://github.com/griffithlab/pVACtools/pull/1451
