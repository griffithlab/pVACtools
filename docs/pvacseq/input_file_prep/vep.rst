...
The plugins can also be downloaded from the `pVACtools GitHub repository <https://github.com/griffithlab/pVACtools/tree/master/pvactools/tools/pvacseq/VEP_plugins>`_ directly.
