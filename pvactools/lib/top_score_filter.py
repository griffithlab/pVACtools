...
class PvacseqTopScoreFilter(TopScoreFilter, metaclass=ABCMeta):
    ...
    def find_best_line(self, lines):
        ...
        tsl_lines = [x for x in biotype_lines if x['Transcript Support Level'] != 'NA' and x['Transcript Support Level'] != 'Not Supported' and x['Transcript Support Level'] < self.maximum_transcript_support_level]
