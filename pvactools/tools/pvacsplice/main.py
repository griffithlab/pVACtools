...
def define_parser():
    ...
    net_chop_parser = subparsers.add_parser(
        "net_chop",
        help="Run NetChop on existing pVACsplice output .tsv to predict cleavage sites on the neoepitopes.",
        add_help=False,
    )
    ...
    netmhc_stab_parser = subparsers.add_parser(
        "netmhc_stab",
        help="Run NetMHCStabPan on existing pVACsplice output .tsv to add stability predictions to the neoepitopes.",
        add_help=False,
    )
    ...
    calculate_reference_proteome_similarity_parser = subparsers.add_parser(
        ...
        help="Blast peptides against the reference proteome on existing pVACsplice output .tsv.",
        add_help=False
    )
