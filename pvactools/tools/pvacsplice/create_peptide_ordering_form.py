...
from pvactools.lib.create_peptide_ordering_form import PvacspliceCreatePeptideOrderingForm

def define_parser():
    return PvacspliceCreatePeptideOrderingForm.parser('pvacsplice')
...
def main(args_input = sys.argv[1:]):
    ...
    creator = PvacspliceCreatePeptideOrderingForm(**params)
    creator.execute()
