        ...
        conditionalPanel(
          ...
          fluidRow(
            ...
            box(width= 6, 
                ...
                numericInput("allele_expr_high", "Allele Expression cutoff to be considered a Pass variant", 3, min = 0, max = 100, step = 0.1, width = 500),
                numericInput("allele_expr_low", "Allele Expression cutoff to be considered a Relaxed variant. Note that this criteria is also used in determining Anchor and Subclonal variants.", 1, min = 0, max = 100, step = 0.1, width = 500),
