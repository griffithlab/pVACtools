      ...
      column(width = 6,
             box(width = 12,
                 ...
                 "Current version of pVACseq results defaults to positions 1, 2, n-1 and n (for a n-mer peptide) when determining anchor positions.
                    ...
                    uiOutput("binding_percentile_threshold_ui"),
                    uiOutput("immunogenicity_percentile_threshold_ui"),
                    uiOutput("presentation_percentile_threshold_ui"),
      ...
      box(width = 12, title = "Additional Peptide Information",  status = "primary", solidHeader = TRUE, collapsible = TRUE,
          tabBox(width = 12, title = " ", id = "info",
                 ...
                 tabPanel("Binding Plot",
                          ...
                          plotOutput(outputId = "violinPlot_IC50") %>% withSpinner(color = "#8FCCFA"), style = "overflow-x: scroll;"
                 ),
                 ...
                 tabPanel("Presentation Data",
                          ...
                          br(),
                          strong("BigMHC_EL"), span(": A deep learning tool for predicting MHC-I (neo)epitope presentation. ("),
