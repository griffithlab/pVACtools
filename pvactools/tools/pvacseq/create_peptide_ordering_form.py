...
def main(args_input = sys.argv[1:]):
    ...
    peptide_manufacture_path = output_path + f"{args.output_file}.manufacturability.tsv"

    run_generate_reviews_files(
        reviewed_candidates_path=args.input_tsv,
    ...
    peptide_51mer_path = output_path + f"{args.output_file}_{args.sample_name}_Peptides_51-mer.xlsx"
