...
_descriptions = {
    ...
    'all_epitopes.tsv':"Processed data from IEDB, but with no filtering or extra data",
    'filtered.tsv':"Processed data with all filters applied",
    'stab.tsv':"Processed and filtered data, with peptide stability data added",
    'filtered.condensed.ranked.tsv':"A condensed report of the processed and filtered data, with ranking score added",
